namespace CatalogService.Api.Features.SmmmTakip.Dtos
{
    // ---- Okuma ----

    /// <summary>Konu ağacının bir düğümü (nested).</summary>
    ...
    /// <summary>Konu detayı: markdown içerik + hadler.</summary>
    public class SmmmKonuDetayDto
    {
        ...
        /// <summary>Değerlerin çözümlendiği yıl (istekte ?yil verildiyse).</summary>
    ...
    public class SmmmHadDto
    {
        ...
        /// <summary>Seçili yıla ait değer (istekte ?yil verildiyse ve o yıl mevcutsa).</summary>
        public decimal? SeciliDeger { get; set; }
        public int? SeciliYil { get; set; }
        public string? SeciliTeblig { get; set; }
        public string? SeciliNot { get; set; }

        /// <summary>Tüm yıllara ait değerler (yıl azalan).</summary>
    ...
    public class SmmmKonuSaveDto
    {
        public int? UstKonuId { get; set; }
        public string Baslik { get; set; } = string.Empty;
        /// <summary>Boş bırakılırsa başlıktan üretilir.</summary>
    ...
    /// <summary>Yıl bazlı upsert için (HadId, Yil) anahtar.</summary>
