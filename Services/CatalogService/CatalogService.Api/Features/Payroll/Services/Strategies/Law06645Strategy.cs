...
{
    // 6645 sayılı Kanun Geçici 62. madde — 6486'nın devamı niteliğinde, farklı kriter grubuna yönelik.
    // İşveren SGK payının tamamı ve işveren işsizlik payı İşsizlik Sigortası Fonu tarafından karşılanır.
    public class Law06645Strategy : IPayrollIncentiveStrategy
    {
