...
namespace SovosService.Api.Persistence;

public class SovosServiceDbContext : DbContext
{
    public SovosServiceDbContext(DbContextOptions<SovosServiceDbContext> options) : base(options) { }
